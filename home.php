...
<body>
    ...
    <table>
        ...
        $sql = "SELECT cat.category as category_name, SUM(prior.priority) AS pr,(SELECT COUNT(cid) FROM `spark_priorities` WHERE cid=prior.cid ) as catCount FROM `spark_priorities` AS prior JOIN spark_categories as cat ON prior.cid = cat.id GROUP by cid ORDER BY pr DESC;";
