            ...
            <div class="col-md-8">
                <form action="process" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col">
                            <div class="form-outline mb-4">
                                ...
                                <textarea class="form-control" id="remark" rows="1" name="remark" placeholder="Provide your suggestion..."></textarea>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        Have an account? <a href="login" class="text-warning">Log in</a>
                    </div>
